...
Programs make_Label1(Declaracoes p1, Instrucoes p2, Inteiro p3)
{
    Programs tmp = (Programs) malloc(sizeof(*tmp));
    if (!tmp)
    {
...
Programs clone_Programs(Programs p)
{
  ...
  default:
    fprintf(stderr, "Error: bad kind field when cloning Programs!\n");
    exit(1);
  }
}
...
void free_Programs(Programs p)
{
  ...
  default:
    fprintf(stderr, "Error: bad kind field when freeing Programs!\n");
    exit(1);
  }
  free(p);
}
